 ...
 * @LastEditTime: 2021-10-15 14:37:39
 * @LastEditors: 阮志雄
 * @Description:相机回收
 * @FilePath: \Protected-Area-Resources-Monitor-and-Management-System\src\views\camera-management\widgets\camera-recycle.vue
-->
<template>
  <div class="camera-sub-block">
    ...
    <div class="config-block">
      ...
      <p class="config-item"><span class="teil">计划回收时间:</span><span class="sub-teil">2021-10-08</span></p>
      <p class="config-item">
